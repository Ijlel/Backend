...
const signup = async (req, res) => {
    try {
        ...
        const token = jwt.sign(
            ...
            { expiresIn: '100h' }
                ...
                res.cookie('token', token, {
                    ...
                    secure: process.env.NODE_ENV === 'production',     // Token is sent only over HTTPS
       ...
       // Si c'est une erreur de validation, on peut obtenir plus d'infos
       if (error.name === 'ValidationError') {
        // Exemple d'affichage des erreurs de validation
...
const authenticationController = {signup, login, logout}
